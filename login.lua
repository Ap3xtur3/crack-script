function Main()
menu = gg.choice({'🔵Daniyal City🔵','🔵Monster Legends🔵'},nil, '🔵Game Tool🔵')
if menu == 1 then as() 
while true do
...
if not internet_a then gg.alert('SERVER: Allow Internet Connection...') else pcall(gg.alert(internet_a)) end
end
